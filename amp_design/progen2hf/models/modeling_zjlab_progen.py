...
class RotaryEmbedding(nn.Module):
    ...
    def forward(self, max_seq_len, offset=0):
        ...
        freqs = torch.einsum('i , j -> i j', seq.type_as(self.inv_freq), self.inv_freq)
...
class GPT2Attention(nn.Module):
    ...
    def forward(
        ...
        # hidden_states = torch.load('debug/ln_1.pt')[:195, 0].unsqueeze(0)
...
class GPT2MLP(nn.Module):
    def __init__(self, intermediate_size, config):
        ...
        self.c_fc = Conv1D(2*intermediate_size, embed_dim) # using swiglu
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        rotary_pos_emb = self.rotary_pos_emb(kv_seq_len)
            ...
            if self.gradient_checkpointing and self.training:
                ...
                def create_custom_forward(module):
                    def custom_forward(*inputs):
                        ...
                        return module(*inputs, use_cache, output_attentions, rotary_pos_emb)
