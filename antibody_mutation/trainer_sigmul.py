...
def main():
    ...
    ckpt_name = f"{model_name}_{data_name}-{monitor}_lr-{args.lr}_loss-{args.loss}_tok33"
    model_checkpoint = ModelCheckpoint(
        (
            f"checkpoints_identity_sigmul/{data_name}"
            if args.rm_abnormal
    ...
    if not args.rm_abnormal:
        metrics_folder = f"results_sigmul/{model_name}/{data_name}_{args.loss}_tok33"
    else:
        metrics_folder = f"results_identity_sigmul/{model_name}/{data_name}_{args.loss}_tok33"
